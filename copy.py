...
FILES_TO_FIND = [
    ...
    "data.py",
    "tester.py",
    # Add any other relevant files if needed, e.g., utility files imported by the above
    # "utils.py",
    # Based on the traceback, these might also be relevant if the above aren't found
    # or if they contain essential code:
    "__init__.py", # Often found in module directories like attacks/, models/, etc.
    "CommonWeakness.py",
    "utils.py", # Be careful, there might be multiple utils.py files
    "ImageHandling.py",
]
